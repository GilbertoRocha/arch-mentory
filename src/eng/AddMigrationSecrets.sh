...
curl -k -X PUT "https://vault.localhost:8444/secrets/DB-CONNECTION?api-version=7.4" \
	...
	-d '{"value":"Host=localhost;Port=5432;Database=Mentory;Username=postgres;Password=postgres;SSL Mode=Prefer;Trust Server Certificate=true"}'


echo -e "\e[32m Secrets for migration added \e[0m"
